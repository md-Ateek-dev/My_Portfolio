      ...
      <div className='relative z-10 flex flex-col items-center justify-center px-6 py-16 gap-16 w-full min-h-screen'>
        ...
        <div className={`text-center transform transition-all duration-1000 ${isVisible ? 'translate-y-0 opacity-100' : 'translate-y-10 opacity-0'}`}>
          <div className="relative">
            <h1 className='text-5xl sm:text-6xl lg:text-7xl font-black text-transparent bg-clip-text bg-gradient-to-r from-white via-blue-200 to-cyan-200 mb-6 tracking-tight'>
              My Latest Work
            </h1>
